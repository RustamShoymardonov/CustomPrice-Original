...
$(document).ready(function () {
    ...
    }), o <= 991 && ($(".main-search").addClass("open"), $(".main-search .form-control").css({width: "100px"})), $(".noti-body")[0]) {
    ...
    if (!$(".pcoded-navbar").hasClass("theme-horizontal")) {
        var o = $(window)[0].innerWidth;
        if ($(".navbar-content")[0]) if (o < 992 || $(".pcoded-navbar").hasClass("menupos-static")) {
    ...
    $(".card-option .close-card").on("click", function () {
        ...
        if (o.toggleClass("full-card"), $(this).children("a").children("span").toggle(), o.hasClass("full-card")) {
            ...
            var d = $(o, this), n = d.offset(), s = n.left, i = n.top, r = $(window).height(), a = $(window).width();
    ...
    var o = (this.attr("id"), {themelayout: "vertical", MenuTrigger: "click", SubMenuTrigger: "click"}),
        e = $.extend({}, o, e), d = {
            PcodedMenuInit: function () {
                ...
                var o = $(window), d = o.width();
                if (1 == $(".pcoded-navbar").hasClass("theme-horizontal") || 1 == $(".pcoded-navbar").hasClass("theme-horizontal-dis")) if (d >= 992) {
                    ...
                    if (1 == $(".pcoded-navbar").hasClass("theme-horizontal")) {
                        ...
                        o.off("click").off("mouseenter mouseleave").hover(function () {
                            if ($(this).addClass("pcoded-trigger").addClass("active"), $(".pcoded-submenu", this).length) {
                                var e = $(".pcoded-submenu:first", this), o = e.offset(), d = o.left, n = e.width();
                                if ($(window).height(), d + n <= $(window).width()) $(this).removeClass("edge"); else {
                    ...
                    case"horizontal":
                        "hover" === e.SubMenuTrigger ? $("li.pcoded-hasmenu").on("mouseenter mouseleave", function (e) {
                            if ($(".pcoded-submenu", this).length) {
                                var o = $(".pcoded-submenu:first", this), d = o.offset(), n = d.left, s = o.width();
                                $(window).height();
