...
$(document).ready(function () {
    $("body").append('<div id="styleSelector" class="menu-styler">' +
        '<div class="style-toggler">' +
        '<a href="#!" style="top: 90%"></a>' +
        '</div>' +
        '<div class="style-block" style="bottom: 5%; top: 5%">' +
        '<h4 class="mb-2">E-TRANZITIN <small class="font-weight-normal">Сайт созламалари</small></h4>' +
        '<hr class="">' +
        '<div class="m-style-scroller">' +
        '<h6 class="mt-2">Тема</h6>' +
        ...
        '<a href="#!" class="" data-value="reset" title="Reset">Одатий</a>' +
        '</div>' +
        '<h6>фон ранги</h6>' +
        ...
        '<a href="#!" class="active" data-value="background-purple"><span></span><span></span></a>' +
        ...
        '</div>' +
        '<label>Ён панелни қотириш</label>' +
        '</div>' +
        '<div class="form-group mb-2">' +
        '<div class="switch switch-primary d-inline m-r-10">' +
        ...
        '</div>' +
        '<label>Сарлавҳани қотириш</label>' +
        '</div>' +
        // '<div class="form-group mb-2">' +
        //     '<div class="switch switch-primary d-inline m-r-10">' +
        ...
        '<div class="form-group mb-2">' +
        '<div class="switch switch-primary d-inline m-r-10">' +
        '<input type="checkbox" id="breadcumb-layouts" checked>' +
        '<label for="breadcumb-layouts" class="cr"></label>' +
        '</div>' +
        '<label>Манзил тарихи</label>' +
        '</div>' +
        '</div>' +
    ...
    $(".layout-type > a").on("click", function () {
        ...
        if (a == "dark") {
            ...
            $(".layout-css").attr("href", "resources/css/layout-dark.css")
        } else {
