    ...
    var q = function (l) {
        ...
        b.extend(d.prototype, {
            version: "3.0.0", options: {
                ...
                destroy: !0,
                stack: k
            }, modules: {}, runModules: function (c, a) {
                var p, b;
            ...
            timerHide: !1, init: function () {
                ...
                this.elem = b("<div />", {
                    "class": "ui-pnotify " + this.options.addclass, css: {display: "none"}, "aria-live": "assertive", "aria-role": "alertdialog", mouseenter: function (a) {
