...
<%--                    <div class="">--%>
<%--                        <div onclick="javascript:DigestsFirst(0)" class="col-md-6 col-lg-4 column">--%>
<%--                            <div class="card gr-1">--%>
<%--                                <div class="txt">--%>
<%--                                    <h1>ШАРТЛИ БЕЛГИЛАНГАН </br>--%>
<%--                                        ТОВАРЛАР</h1>--%>
<%--                                    <p>ШАРТЛИ БОЖХОНА ҚИЙМАТИНИ БЕЛГИЛАШ ОРҚАЛИ ТОВАРЛАРНИ ЧИҚАРИШ</p>--%>
<%--                                </div>--%>
<%--                                <a href="www.google.com">БАТАФСИЛ</a>--%>
<%--                                <div class="ico-card">--%>
...
<%--                            <div class="card gr-3">--%>
<%--                                <div class="txt">--%>
<%--                                    <h1>ХОРИЖИЙ БОЖХОНА </br>ХИЗМАТИ МАЪЛУМОТЛАРИ</h1>--%>
<%--                                    <p>-------------------------------</p>--%>
<%--                                </div>--%>
<%--                                <a href="#">БАТАФСИЛ</a>--%>
<%--                                <div class="ico-card">--%>
...
<%--                            <div class="card gr-1">--%>
<%--                                <div class="txt">--%>
<%--                                    <h1>БОЖХОНА ҚИЙМАТИНИ </br>--%>
<%--                                        ХАВОЛА ҚИЛИШ ТАРИХИ</h1>--%>
<%--                                    <p>------------------------</p>--%>
<%--                                </div>--%>
<%--                                <a href="#">БАТАФСИЛ</a>--%>
<%--                                <div class="ico-card">--%>
...
<%--                            <div class="card gr-1">--%>
<%--                                <div class="txt">--%>
<%--                                    <h1>БОЖХОНА ҚИЙМАТИ БЎЙИЧА</br>--%>
<%--                                        МАВЖУД ХАТОЛИКЛАР</h1>--%>
<%--                                    <p>------------------------</p>--%>
<%--                                </div>--%>
<%--                                <a href="#">БАТАФСИЛ</a>--%>
<%--                                <div class="ico-card">--%>
