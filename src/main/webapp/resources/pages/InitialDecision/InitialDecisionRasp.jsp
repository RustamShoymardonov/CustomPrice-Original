                                ...
                                <table class="table table-striped jambo_table bulk_action mt-4">
                                    ...
                                    <tr class="headings">
                                        ...
                                        <th class="bulk-actions" colspan="2">
                                            <a class="antoo" style="color:#fff; font-weight:500; font-size: 18px">Танланган
                                                аризалар сони( <span class="action-cnt"> </span> )</a>
                                        </th>
                                        <th class="bulk-actions" colspan="4">
                                            <select class="select2_single border-0 w-50" tabindex="-1"
                                                    style=" background: #405467; color: #fff; font-size: 18px">
                                        ...
                                        <th class="bulk-actions" colspan="1" style=>
                                            <a type="button" class="border border-success bg-success rounded-2"
                                               style="font-size: 18px"><i class="fa fa-share ml-2 mr-2"></i>Тақсимлаш&ensp;</a>
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        <div class="x_content">
                            <div class="table-responsive mt-4">
                                <table id="datatable" class="table table-striped table-bordered mt-4"
                                       style="width:100%">
