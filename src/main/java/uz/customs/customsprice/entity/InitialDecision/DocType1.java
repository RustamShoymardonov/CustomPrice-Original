...
//    @GenericGenerator(name = "uuid4", strategy = "org.hibernate.id.UUIDGenerator")
    ...
    public DocType1(Integer itemsNo, String docFullName, String docCodeName, String mask, int isDeleted, String priznakEldoc, Date startDate, Date finishDate) {
