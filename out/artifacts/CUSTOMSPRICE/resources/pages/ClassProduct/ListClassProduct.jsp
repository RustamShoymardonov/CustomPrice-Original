                ...
                <form class="form-label-left input_mask mt-2">
                    ...
                    <div class="col-md-4 col-sm-4  form-group has-feedback">
                        <div class="form-group pmd-textfield pmd-textfield-floating-label border border-primary">
                            <input placeholder="Сана: дан" class="form-control" min="2015-01-01T00:00" max="2025-01-01T00:00" type="text" onfocus="(this.type='datetime-local')"
                    ...
                    <div class="col-md-4 col-sm-4  form-group has-feedback">
                        <div class="form-group pmd-textfield pmd-textfield-floating-label border border-primary">
                            <input placeholder="Сана: гача" class="form-control" min="2015-01-01T00:00" max="2025-01-01T00:00" type="text" onfocus="(this.type='datetime-local')"
