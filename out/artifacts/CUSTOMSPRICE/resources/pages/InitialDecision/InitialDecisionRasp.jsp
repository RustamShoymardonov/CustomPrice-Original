                                ...
                                <table id="example1" class="table table-striped table-bordered border-primary table-sm" style="width:100%; border-style: dashed solid">
                                    ...
                                    <c:forEach var="notSorted" items="${notSortedList}" varStatus="i">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-control" id="userId_${i.index+1}" name="userId_${i.index+1}">
                                                    <option value=""></option>
                                                    <option value="17507">SOXIBOV ASILBEK ASKAR OGLI</option>
                                                    <option value="18226">ARZIYEV NURIDDIN PARDA OGLI</option>
                                                    <option value="20103">MINGBOYEV ABBOSBEK ULUGBEK OGLI</option>
                                                </select>
                                                <input type="hidden" id="appId_${i.index+1}" name="appId_${i.index+1}" value="<c:out value="${appId}"/>"/>
                                                <c:set var="rowCount" value="${rowCount + (i.index+1)}"/>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    <input type="hidden1" id="rowCountS" name="rowCountS" value="<c:out value="${rowCount}"/>"/>
                                    </tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th style="border-style: dotted">
                                            <button type="button" class="btn btn-success btn-block" onclick="saveInDecRasp()">Тақсимлаш</button>
                                        </th>
                                    </tr>
                                    </tfoot>
...
<script>
    ...
    function saveInDecRasp() {
        var rowCountS = parseInt($("input#rowCountS").val());
        // alert(rowCountS);
        var dataS = {
            "appIdS": "123456789",
            "userIdS": "723457"
        ...
        //     if ($.trim($("select#userId_" + i).val()) != null && $.trim($("select#userId_" + i).val()) != '') {
        //         // alert(i + " := " + $("#userId_" + i).val() + ', appId := ' + $("#appId_" + i).val());
        //         dataS.userIdS.push({userIdS: $.trim($("#userId_" + i).val())});
        //         dataS.appIdS.push({appIdS: $.trim($("#appId_" + i).val())});
        //     }
        // }
